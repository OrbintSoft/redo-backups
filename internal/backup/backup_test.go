...
func TestPartitionPipelineExt4(t *testing.T) {
	...
	p := PartitionPipeline(part, config.CompressorPigz, "4096M", "/tmp/sda2.log", "/dest", "20260105")
	want := []string{
...
func TestPartitionPipelineDDFallback(t *testing.T) {
	...
	p := PartitionPipeline(part, config.CompressorGzip, "2G", "/tmp/sda3.log", "/dest", "id1")
	want := []string{
